...
@Component({
  selector: 'app-external-inboxout',
  templateUrl: './external-inboxout.component.html',
  styleUrls: ['./external-inboxout.component.css']
})
export class ExternalInboxoutComponent implements OnInit {
  ...
  openSubject(subject){
    ...
    const dialog = this.dialog.open(ExternalInboxoutPreviewComponent, dialogConfig);
